...
This educational basic project will be carried out using Kali as the attack machine and a virtual LAN (VLAN) designed to closely replicate the target network, and will be divided into two stages: 
